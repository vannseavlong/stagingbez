  ...
  useEffect(() => {
    ...
    fetch(`${BASE_URL}payment/aba/checkout/payment-link/rest/${id}`, {
      ...
      .then((data) => {
        ...
        setAba(data.data.checkout_qr_url);
      })
      .catch((error) => {
        console.error("Error fetching data:", error);
        setLoading(false);
    ...
    <div className="min-h-screen bg-gray-900 px-2 py-4 flex items-center justify-center">
      <div className="w-full max-w-md bg-white rounded-3xl shadow-2xl overflow-hidden">
        ...
        <div className="px-4 py-4">
          ...
          <div className="grid grid-cols-3 gap-6 mb-6">
            ...
            <div>
              ...
              <div className="font-semibold text-sm">{paymentLinkData?.bulkOrderId || 'N/A'}</div>
            </div>
            <div>
          ...
          <div className="grid grid-cols-3 gap-6 mb-8">
            <div>
              ...
              <div className="font-semibold text-sm">
                {paymentLinkData?.tranInitDate ? moment(paymentLinkData?.tranInitDate).format('DD MMM, YYYY') : moment().format('DD MMM, YYYY')}
              </div>
            </div>
            <div>
        ...
        <div className="px-8 pb-8">
          <button
            disabled={!aba}
            className="h-12 w-full bg-blue-700 text-white text-lg font-semibold rounded-full hover:bg-blue-800 transition-colors"
