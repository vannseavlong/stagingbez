...
<section className="relative min-h-screen bg-cover bg-center bg-white flex items-center justify-center overflow-hidden"> 
  ...
  <div className="relative z-10 text-white text-center px-6">
    <h1
      className="text-[32px] md:text-[40px] lg:text-[48px] font-bold mb-4 font-[Inter]"
      data-aos="fade-up"
      data-aos-delay="200"
    >
      {title}
    ...
    {description && (
      <p
        className="text-base md:text-lg lg:text-xl max-w-[380px] md:max-w-[600px] lg:max-w-[700px] mx-auto font-normal font-[Inter]"
        data-aos="fade-up"
        data-aos-delay="400"
      >
        {description}
